...
namespace project_management_backend.Application.Interface
{
    ...
    {
        Task<Organization> CreateAsync(Organization organization, OrganizationMember organizationMember, Workspace workspace, WorkspaceMember workspaceMember, CancellationToken cancellationToken);
